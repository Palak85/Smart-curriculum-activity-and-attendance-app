      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-4 rounded-lg shadow-sm">
          ...
          <div className="flex flex-col gap-2">
            <button className="py-2 px-3 rounded bg-indigo-600 text-white">Add Student</button>
            <button className="py-2 px-3 rounded bg-indigo-600 text-white">Add Teacher</button>
